...
//后端页面
func (this *IndexController) Admin() {


	this.TplName = "admin/index.html"
}

func (this *IndexController) Settings() {
...
func (this *IndexController) ArticleManage() {

	this.TplName = "admin/articlemanage.html"
}

func (this *IndexController) BannerManage() {

	this.TplName = "admin/bannermanage.html"
}

func (this *IndexController) CategoryManage() {

	this.TplName = "admin/categorymanage.html"
}

func (this *IndexController) MenuManage() {

	this.TplName = "admin/menumanage.html"
}

func (this *IndexController) OtherArticleManage() {

	this.TplName = "admin/otherarticlemanage.html"
}
func (this *IndexController) ConfigManage() {

	this.TplName = "admin/configmanage.html"
}

func (this *IndexController) UserManage() {

	this.TplName = "admin/usermanage.html"
}

func (this *IndexController) ArticleForm() {

	this.TplName = "admin/articleform.html"
}
